...
class TestRingSegment():
    ...
    def test_points_ra_fract(self):
        ...
        assert similar([[17.32,-10], [25.98,-15], [-21.213,-21.213],
            [-14.142,-14.142]], RingSegment(20,-30, 10,255).points_ra())
    ...
    #     assert QRect(0,20, 20,20) == RingSegment(1,0, 10,90).text_bbox_scr()
    ...
    def test_geometry_pos(self):
        x0,y0 = 180,180; r,dr = 10,10; d = r+dr
        pos = [[180,160], [160,160], [160,180], [180,180]]
        for i in range(0,3):
            x,y = ra2xy(r,90*i); x += x0; y = y0 - y
